            ...
            const loadData = async () => {
                ...
                try {
                    ...
                    if (statsRes?.success && statsRes?.data) {
                        ...
                        setStats({
                            total: d.total || 0,
                            newAlerts: d.byStatus?.new || d.byStatus?.New || 0,
                            inProgress: d.byStatus?.inProgress || d.byStatus?.InProgress || 0,
                            escalated: d.byStatus?.escalated || d.byStatus?.Escalated || 0,
                            resolved: d.byStatus?.resolved || d.byStatus?.Resolved || 0,
                            closed: d.byStatus?.closed || d.byStatus?.Closed || 0,
                            critical: d.bySeverity?.critical || d.bySeverity?.Critical || 0,
                            high: d.bySeverity?.high || d.bySeverity?.High || 0,
                            medium: d.bySeverity?.medium || d.bySeverity?.Medium || 0,
                            low: d.bySeverity?.low || d.bySeverity?.Low || 0,
